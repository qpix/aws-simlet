...
A demo showing the simlets in action can be found [here](http://aws-simlet.s3-website-us-east-1.amazonaws.com/demo/). The ´config.sh´ that was used to generate the demo is found [here](aws-simlet.s3-website-us-east-1.amazonaws.com/config.sh).
